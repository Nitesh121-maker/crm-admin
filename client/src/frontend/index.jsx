...
const Index = () => {
   ...
   const invoicetotallength = totalinvoice.length||0;
   //    Get Notification
   useEffect(() => {
                                        ...
                                        <div className='notification-card-content-tab'>
                                            {
                                                ...
                                                notification.map((notification,index)=>(                                             
                                                        <div  className="notify-content p-2 mb-2" style={{ backgroundColor: '#282a36', borderRadius: '0.25rem',cursor:'pointer' }}>
                                                            <p className='mb-3'>Invoice generated By {notification.sales_person_id} to {notification.fullname} of {notification.company}</p>
